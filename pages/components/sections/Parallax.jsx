...
const Parallax = () => {
  return (
    <div
      className="border-2 border-gray-800 grid min-h-screen grid-cols-1 overflow-hidden font-extrabold tracking-tighter bg-fixed bg-no-repeat bg-cover bg-backdrop md:pr-24 lg:pl-20 md:pl-4 sm1:pr-0"
      style={{
        backgroundImage: `url('./media/images/parallax.jpg')`, // 确保图片路径正确

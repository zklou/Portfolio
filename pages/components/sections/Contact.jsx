        ...
        <div>
        {
            ...
            (
                <div className='border-0 border-red-500'>
                  ...
                  <div className='m-auto font-normal text-blue-400 border-0 border-red-500 sm1:w-4/5 lg:w-3/5 xl:w-full md:text-center sm1:text-3xl md:text-5xl'>
                  ...
                  <div className='flex justify-around w-full m-auto mt-20 text-white border-0 border-red-500'>
                    <div className='flex border-0 border-red-500 xl:space-x-20 sm1:flex-col xl:flex-row sm1:space-y-2 md:space-y-8 xl:space-y-0'>
                      <a href="mailto:zhengkunlou@gmail.com" className='border-0 border-red-500'>
                        <div className='flex flex-row space-x-4 sm1:hidden md:flex'>
                          ...
                          <div className='leading-[1rem]'>
                            ...
                            <p className='sm1:text-xs md:text-sm text-white/50'>Personal Email</p>
                          </div>
                        </div>
                      </a>
                      <a href="tel:+14168860087" className='border-0 border-red-500'>    
                      ...
                      <div className='flex space-x-4 border-0 border-red-500 sm1:pt-8 md:pt-4 lg:pt-0 md:text-3xl sm1:text-3xl lg:text-2xl'>
                        ...
                        <a className='text-blue-400 rounded-full sm1:p-2 md:p-4 bg-blue-400/20' href="https://www.instagram.com/zklou/" target="_blank" rel="noreferrer"><FiInstagram /></a>

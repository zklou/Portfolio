      ...
      <div className="pb-40 overflow-hidden bg-black sm1:pt-16 md:pt-0">
        ...
        <div className="relative border-0 sm1:hidden md:block h-[50rem]">
          <div className="w-4/5 pt-20 m-auto border-0 opacity-1" id="main">
            <div className="z-0 text-3xl font-light tracking-tighter text-gray-300 border-0 font-change2">
              ...
              <motion.span className="sm1:text-3xl md:text-4xl lg:text-5xl absolute lg:top-[15rem] md:top-[15.5rem] text-gray-300">Hello</motion.span>
              <span className="border-0 absolute top-[16.5rem] xl:left-[18rem] lg:left-[15rem] md:left-[11.5rem] text-gray-300">&nbsp; I&apos;m </span>
              <span className="text-blue-400 border-0 absolute top-[16.5rem] xl:left-[20.8rem] lg:left-[17.5rem] md:left-[14.2rem]">&nbsp;Zhengkun Lou</span>
            </div>

            <div className="absolute z-10 font-extrabold tracking-tighter text-white lg:text-7xl xl:text-8xl font-change2 top-[20rem]">FULLSTACK</div>
            <div className="absolute z-10 font-extrabold tracking-tighter text-blue-400/80 lg:text-7xl xl:text-8xl font-change2 xl:top-[28rem]">
              WEB DEVELOPER
            </div>
          </div>

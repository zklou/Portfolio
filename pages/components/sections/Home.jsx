    ...
    <>
      <div className="pb-40 overflow-hidden bg-black sm1:pt-16 md:pt-0">
        ...
        <div className="relative border-0 sm1:hidden md:block h-[50rem]">
          <div className="w-4/5 pt-20 m-auto border-0 opacity-1" id="main">
            <div className="z-0 text-2xl font-normal tracking-tighter text-white border-0 font-change2">
              <div className="absolute right-0 w-2/5 text-5xl border-0 sm1:hidden lg:block">
                <Lottie animationData={threedSpheres} className="z-0 grayscale opacity-50 invert" loop={true} />
              </div>
            ...
            <div className="absolute z-10 font-extrabold tracking-tighter text-white lg:text-8xl xl:text-9xl font-change2 xl:top-[28rem] md:top-[25rem] lg:top-[26rem] md:text-7xl sm3:text-7xl">
              <span className="text-blue-400/60 font-stencil23">WEB</span>
          ...
          <motion.div style={{ x: toRight3 }} className="tracking-tighter md:top-[24rem] lg:top-[21rem] absolute text-gray-400/30 z-0 overflow-hidden whitespace-nowrap text-9xl font-extrabold font-stencil24">
            design design design design ...
          </motion.div>
          <motion.div style={{ x: toRight3 }} className="tracking-tighter md:top-[30rem] lg:top-[28rem] absolute text-gray-400/30 z-0 overflow-hidden whitespace-nowrap text-9xl font-extrabold font-stencil24">
            code code code code code ...
          </motion.div>
          <motion.div style={{ x: toRight3 }} className="tracking-tighter md:top-[35rem] lg:top-[34.5rem] absolute text-gray-400/30 z-0 overflow-hidden whitespace-nowrap text-9xl font-extrabold font-stencil24">
            develop develop develop ...
          </motion.div>
          <motion.div style={{ x: toRight3 }} className="tracking-tighter md:top-[42rem] lg:top-[41rem] absolute text-gray-400/30 z-0 overflow-hidden whitespace-nowrap text-9xl font-extrabold font-stencil24">
        ...
        <div id="home" className="relative top-0 max-h-screen bg-cover border-0 sm1:block md:hidden">
          <div className="w-full pt-20 m-auto border-0 opacity-1" id="main">
            <div className="absolute w-2/5 text-5xl border-0 -right-4">
              <Lottie animationData={threedSpheres} className="grayscale opacity-60 invert" loop={true} />
            </div>
            <motion.div style={{ x: toRight2 }} className="top-[12rem] absolute text-gray-400/50 overflow-hidden whitespace-nowrap font-stencil24 text-6xl font-extrabold">
            ...
            <div className="absolute z-20 font-extrabold tracking-tighter text-center font-change2 text-blue-400 sm1:text-6xl sm1:left-3 sm1:top-[17rem] sm2:top-[18rem] sm2:left-0 sm3:left-8">WEB</div>
            <div className="absolute z-0 text-5xl font-extrabold tracking-tighter text-white font-change2 left-3 sm1:top-[21rem] sm2:text-6xl sm2:left-0 sm3:left-8 sm2:top-[21rem]"><span>DEVELOPER</span></div>
            <div className="absolute z-20 text-5xl font-extrabold tracking-tighter text-white font-change2 font-stencil2 left-3 sm1:top-[21rem] sm2:text-6xl sm2:left-0 sm3:left-8 sm2:top-[21rem]"><span>DEVELOPER</span></div>
          </div>
